...
//        // HEADER
        ...
        Portata dessert4 = new Dessert("Torta setteveli", 7.40, "Pan di Spagna, mandorle pugliesi, mousse di nocciole del Piemonte, \ncioccolato Madagascar e un fondo di gianduia croccante ai cereali", TipoDessertEnum.CIOCCOLATO, ChefStellatiEnum.MARCUS_SAMUELSSON, "uova, zucchero, farina, cacao, crema nocciola,cereali al cioccolato,amido di riso, latte, gelatia, panna, pasta di nocciole,cioccolato fondente, schiroppo di glucosio");
        Portata dessert5 = new Dessert("Strudel di mele", 6.38, "Un gustosissimo rotolo di pasta farcito con mele, uvetta, pinoli e cannella.", TipoDessertEnum.FRUTTA, ChefStellatiEnum.VICKY_LAU, "mele, uvetta, marsala o vermouth, confettura di albicocca, mandorle, panna veggetale, zucchero, cannella");
        Portata dessert6 = new Dessert("Gelo di Anguria", 3.99, "Il gelo di mellone (gelu di muluni in siciliano), anche detto gelo d'anguria, \nè un tipico dolce al cucchiaio siciliano, tradizionalmente preparato a Ferragosto", TipoDessertEnum.FRUTTA, ChefStellatiEnum.VICKY_LAU, "succo di anguria amido di frumento, zucchero di canna, anice, gocce di cioccolato fondente");
